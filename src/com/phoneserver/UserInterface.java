 ...
 * @date   30.04.16
 *
 * Main thread for communication with user.
 */
public class UserInterface implements Runnable {

    EntryPair[] phonebook;
    
    public UserInterface(EntryPair[] phonebook) {
        this.phonebook = phonebook;
        System.out.println("Hello");
        Thread t1 = new Thread(this);
        t1.start();
//        AnimatorThread empfThread = new AnimatorThread(this);
//        empfThread.startExecution();
    }
